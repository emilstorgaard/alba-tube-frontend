<script lang="ts">
    import { currentSong, currentSongIndex, shuffledOrder, isShuffleEnabled, isPaused, currentTime, duration, volume } from '$lib/stores/songStore';
...
<div class="text-white flex flex-col w-full">
    <div class="flex justify-center items-center space-x-4">
        ...
        <button 
            ...
            disabled={
                $isShuffleEnabled
                    ? $shuffledOrder[0] === $currentSongIndex
        ...
        <button 
            ...
            disabled={
                $isShuffleEnabled
                    ? $shuffledOrder.at(-1) === $currentSongIndex
                    : $currentSongIndex === null || $currentSongIndex >= $selectedPlaylistSongsStore.length - 1
            }>
