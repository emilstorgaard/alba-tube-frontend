...
<div class="flex-grow flex flex-col lg:flex-row gap-4 px-4 py-4 min-h-[85vh]">
    {#if $userStore}
        <div class="lg:w-1/4 w-full flex flex-col gap-4 lg:h-[85vh]">
            <!-- Profil boks -->
<div class="flex flex-col bg-dark-gray rounded-lg shadow-md p-4 hover:shadow-lg transition-shadow duration-200">
    ...
    >
        ...
        <div class="flex flex-col justify-center">
            ...
            <!-- Abonnenter boks -->
            <div class="flex flex-col bg-dark-gray rounded-lg shadow-lg p-4 overflow-y-auto flex-1 h-32 lg:h-auto">
    ...
    <!-- Video boks -->
    <div class="lg:w-3/4 w-full flex flex-col bg-dark-gray rounded-lg shadow-lg p-4 overflow-y-auto lg:h-[85vh] scrollbar-thin scrollbar-thumb-gray scrollbar-track-dark-gray">
        {#if $selectedUserStore}
